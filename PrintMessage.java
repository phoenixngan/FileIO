...
public class PrintMessage {
   ...
   /**
    * Displays the options for adding data or quitting the program.
    */
   public static void showAddQuit() {
    ...
    *
    * @param type the file type that does not exist
    */
   public static void noFileTypeExistsError(String type) {
       System.out.println("There are no files of type \"" + type + "\"; please add data or create the file.");
   }
   ...
   /**
    * Displays an error message indicating an unexpected exception has occurred.
    *
    * @param errorMessage the error message to display
    */
   public static void unexpectedExceptionError(String errorMessage) {
       System.out.println("An unexpected exception has occurred; " + errorMessage +
                           "\nPlease contact the programmer(s) or try again.");
   }
